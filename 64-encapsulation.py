...
# Encapsulation
# binding of data and functions that manipulate the data, and encapsulate in one object.
# Data and functions are data and methods, we encapsulate the player data, and we
# have functions that perform actions on the data, we can pack data and methods
# ---------------------------------------------------------------------------------------
